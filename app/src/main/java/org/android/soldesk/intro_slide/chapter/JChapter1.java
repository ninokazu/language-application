...
public class JChapter1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbh = new DBHelper(JChapter1.this, "WORD_TABLE.db", null, 1);
        ...
        korStudySub.setText("Capter 1");
        saveNum = 0;
        random = 0;
        chap1 = dbh.chapselect(1, 2);
