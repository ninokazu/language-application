...
public class JChapter3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbh = new DBHelper(JChapter3.this, "WORD_TABLE.db", null, 1);
        ...
        korStudySub.setText("Capter 3");
        saveNum = 0;
        random = 0;
        chap1 = dbh.chapselect(3, 2);
