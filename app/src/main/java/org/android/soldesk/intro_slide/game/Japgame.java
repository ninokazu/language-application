...
import org.android.soldesk.intro_slide.game.game3.JapWordGameActivity;

/**
 * Created by shin on 2017-05-10.
 */

public class Japgame extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btngame3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), JapWordGameActivity.class);
                startActivity(intent);
            }
        });
    }
