...
public class JChapter5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbh = new DBHelper(JChapter5.this, "WORD_TABLE.db", null, 1);
        ...
        korStudySub.setText("Capter 5");
        saveNum = 0;
        random = 0;
        chap1 = dbh.chapselect(5, 2);
