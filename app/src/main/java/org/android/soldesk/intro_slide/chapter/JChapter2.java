...
public class JChapter2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbh = new DBHelper(JChapter2.this, "WORD_TABLE.db", null, 1);
        ...
        korStudySub.setText("Capter 2");
        saveNum = 0;
        random = 0;
        chap1 = dbh.chapselect(2, 2);
